...
const server = setupServer(
  rest.get("https://fakestoreapi.com/products",
  (req, res, ctx) => {
...
it("renders a Header component", async () => {
  ...
  render(
    <BrowserRouter>
        <CategoryPage />
    </BrowserRouter>, { initialState: mockStore}
  );
...
/*
 ...
 - when component is loading it returns a loading spinner. The ItemTile component is not rendered

 - when component is not loading the ItemTile component is rendered
